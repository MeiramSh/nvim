...
function M.setup(config)
    ...
    theme.base = {
        ...
        LspDiagnosticsVirtualTextInformation = {
            bg = util.darken(c.info, 0.1),
            fg = c.info,
        }, -- Used for "Information" diagnostic virtual text
        LspDiagnosticsVirtualTextHint = {
            bg = util.darken(c.hint, 0.1),
            fg = c.hint,
    ...
    theme.plugins = {
        ...
        -- HASKELL
        haskellTSType = { fg = c.purple },
        haskellTSConstMacro = { fg = c.red },
        haskellTSExtension = { fg = c.syntax.keyword },
        haskellTSConstrucotr = { fg = c.green },
    ...
    if config.hide_inactive_statusline then
        ...
        -- StatusLine
        inactive =
            { style = 'underline', bg = c.bg, fg = c.bg, sp = c.bg_visual }
